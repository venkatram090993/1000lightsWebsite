  ...
  return (
    <div class="flex flex-col m-auto">
      <div class="lg:w-5/6 m-auto sm:w-5/6 xs: w-5/6 ">
        ...
        <p
          class="text-center lg:text-xl mt-4 whitespace-pre-wrap sm: text-xl"
          style={{ color: "#7C8088" }}
        >
          Mobile
          ...
          that we copied over from web apps. Lights has few UI components
      ...
      <div class="box col-md-4 lg:m-5 lg:w-full md:w-full flex flex-col lg:p-2 m-auto sm: my-2 sm:w-5/6 xs: w-5/6 ">
          ...
          <div class="flex flex-col justify-center">
            ...
            <p class="text-center text-base mx-8 sm:px-10 my-5 text-gray-800 ">
